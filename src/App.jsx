...
const App = () => {
  ...
  async function fixCode() {
    setLoading(true);
    setResponse(""); // Optionally clear previous response
    const response = await ai.models.generateContent({
      model: "gemini-2.0-flash",
      contents: `You are an expert-level software developer.
      Please fix and improve the following ${selectedOption.value} code.
    ...
    setCode(response.text); // Update editor with fixed code
    setLoading(false);
  }
